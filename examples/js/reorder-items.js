	  ...
	  _createClass(_Items, [{
	    ...
	    value: function render() {
	      ...
	      var children = items.toArray().map(function (item, index) {
	        return React.createElement(Item, { key: item.get('name'),
	          item: item,
