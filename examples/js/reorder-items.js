...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = (0, _immutable.fromJS)({
	  items: [{ name: 'one', value: 0 }, { name: 'two', value: 1 }, { name: 'three', value: 2 }]
	});
	
	var inc = function inc(n) {
	  return n + 1;
	};
	var reverse = function reverse(data) {
	  return data.reverse();
	};
	...
	var Item = (function (_Component) {
	  ...
	  Item = elegant({ statics: ['editValue'] })(Item) || Item;
	  return Item;
	})(_react.Component);
	...
	var Items = (function (_Component2) {
	  ...
	  _createClass(_Items, [{
	    ...
	    value: function render() {
	      ...
	      var children = items.toArray().map(function (item, index) {
	        return _react2['default'].createElement(Item, { key: item.get('name'),
	          item: item,
	  ...
	  Items = elegant({ statics: ['edit'] })(Items) || Items;
	  return Items;
	})(_react.Component);
